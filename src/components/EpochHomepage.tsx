...
{/* 
        ...
        >
          <div className={styles.expertiseInner}>
            <div className={styles.sectionHeader}>
              <p className={styles.sectionLabel} id="expertise-heading">
                What we do
              </p>
        ...
        <section className={styles.clients} id="clients" aria-labelledby="clients-heading">
          <div className={styles.clientsInner}>
            <div className={styles.sectionHeader}>
              <p className={styles.sectionLabel} id="clients-heading">Trusted partnerships</p>
              <h2 className={styles.sectionTitle}>Industry leaders who chose Epoch</h2>
            </div>
              ...
              <div className={styles.footerBottomRight}>
                <div className={styles.footerMetadata}>
                  ...
                  <span className={styles.metadata}>
                    ...
                    <span className={styles.metadataValue}>2024.1</span>
                  </span>
                  <span className={styles.metadata}>
                    <span className={styles.metadataLabel}>Build:</span>
                    <span className={styles.metadataValue}>#4A7C</span>
                  </span>
                </div>
              </div>
            </div>
