            ...
            <div className={styles.contactMethods}>
              ...
              <div className={styles.socialSection}>
                ...
                <div className={styles.socialLinks}>
                  <a href="https://linkedin.com/company/epoch-software-services" className={styles.socialLink} aria-label="LinkedIn">
                  ...
                  <a href="/contact#" className={styles.socialLink} aria-label="Twitter">
                    <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
